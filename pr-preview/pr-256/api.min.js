  ...
  render() {
    ...
    return x`
      <div class="componentWrapper">
        ...
        <div class="${e(labelClasses)}" part="label">
          <slot></slot>
        </div>
      </div>
    `;
